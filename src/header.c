...
WriteWav(int f, long int bytes)
{
  ...
  (void) write(f,"RIFF",4);               /*  0-3 */
  PutNum(bytes+44-8,f,0,4);        /*  4-7 */
  (void) write(f,"WAVEfmt ",8);           /*  8-15 */
...
WriteAiff(int f, long int bytes)
{
  ...
  (void) write(f,"FORM",4);             /*  4 */
  PutNum(size-8,f,1,4);          	/*  8 */
  (void) write(f,"AIFF",4);             /* 12 */

  (void) write(f,"COMM",4);             /* 16 */
  PutNum(18,f,1,4);              	/* 20 */
  PutNum(2,f,1,2);               	/* 22 */
  PutNum(frames,f,1,4);          	/* 26 */    
  PutNum(16,f,1,2);              	/* 28 */
  (void) write(f,"@\016\254D\0\0\0\0\0\0",10); /* 38 (44.100 as a float) */

  (void) write(f,"SSND",4);             /* 42 */
...
WriteAifc(int f, long bytes)
{
  ...
  (void) write(f,"FORM",4);             /*  4 */
  PutNum(size-8,f,1,4);          	/*  8 */
  (void) write(f,"AIFC",4);             /* 12 */
  (void) write(f,"FVER",4);             /* 16 */
  PutNum(4,f,1,4);               	/* 20 */
  PutNum(2726318400UL,f,1,4);    	/* 24 */

  (void) write(f,"COMM",4);             /* 28 */
  PutNum(38,f,1,4);              	/* 32 */
  PutNum(2,f,1,2);               	/* 34 */
  PutNum(frames,f,1,4);          	/* 38 */    
  PutNum(16,f,1,2);              	/* 40 */
  (void) write(f,"@\016\254D\0\0\0\0\0\0",10); /* 50 (44.100 as a float) */

  (void) write(f,"NONE",4);             /* 54 */
  PutNum(14,f,1,1);              	/* 55 */
  (void) write(f,"not compressed",14);  /* 69 */
  PutNum(0,f,1,1);               	/* 70 */

  (void) write(f,"SSND",4);             /* 74 */
